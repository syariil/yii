...
use backend\modules\bimtekmagang\models\BimtekSearch;
...
class BimtekController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Bimtek",
                    'content'=>'<span class="text-success">Create Bimtek success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Bimtek model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Bimtek model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = Bimtek::findOne($id)) !== null) {
            return $model;
        } else {
