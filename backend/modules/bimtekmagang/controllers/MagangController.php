...
namespace backend\modules\bimtekmagang\controllers;

use Yii;
use common\models\bimtekmagang\Magang;
use backend\modules\bimtekmagang\models\MagangSearch;
...
class MagangController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Magang",
                    'content'=>'<span class="text-success">Create Magang success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Magang model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Magang model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = Magang::findOne($id)) !== null) {
            return $model;
        } else {
