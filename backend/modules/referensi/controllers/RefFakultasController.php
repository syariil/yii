...
use backend\modules\referensi\models\RefFakultasSearch;
...
/**
 * RefFakultasController implements the CRUD actions for RefFakultas model.
 */
class RefFakultasController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefFakultas",
                    'content'=>'<span class="text-success">Create RefFakultas success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing RefFakultas model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefFakultas model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
