...
use Yii;
use common\models\referensi\RefProdi;
use backend\modules\referensi\models\RefProdiSearch;
...
/**
 * RefProdiController implements the CRUD actions for RefProdi model.
 */
class RefProdiController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefProdi",
                    'content'=>'<span class="text-success">Create RefProdi success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing RefProdi model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefProdi model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
