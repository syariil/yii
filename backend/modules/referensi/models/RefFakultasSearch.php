...
use common\models\referensi\RefFakultas;

/**
 * RefFakultasSearch represents the model behind the search form about `common\models\referensi\RefFakultas`.
 */
class RefFakultasSearch extends RefFakultas
{
    ...
    public function rules()
    {
        return [
            ...
            [['FAKULTAS', 'CREATE_DATE', 'CREATE_IP', 'UPDATE_DATE', 'UPDATE_IP'], 'safe'],
        ];
    }
