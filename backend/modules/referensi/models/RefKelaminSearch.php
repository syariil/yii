...
/**
 * RefKelaminSearch represents the model behind the search form about `common\models\referensi\RefKelamin`.
 */
class RefKelaminSearch extends RefKelamin
{
    /**
     * @inheritdoc
     */
